      ...
      <div class="grid gap-8 p-5 sm:p-7 lg:grid-cols-[1fr_360px] lg:p-8">
        ...
        <aside class="lg:sticky lg:top-24 lg:self-start">
          <div class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <div class="mt-5">
              <div class="grid grid-cols-2 gap-2 sm:grid-cols-4" role="group" aria-label="Filter kamar">
                <button type="button"
    ...
    return {
      ...
      get filteredRooms() {
        return this.rooms.filter((room) => {
          ...
          if (this.roomFilter === '1_orang') return Number(room.kapasitas) >= 1;
          if (this.roomFilter === '2_orang') return Number(room.kapasitas) >= 2;
          return true;
        });
      },
      get totalRoomPages() {
